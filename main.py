                                    ...
                                    if usuario[28+2*6*nomeGrupo+2*nomeJogo] != '':
                                        ...
                                        if not inicioJogo:
                                            for contadorUsuario in range(1, len(usuariosLista), 1):
                                                pontuacaoJogo = 0
                                                usuariosLista[contadorUsuario], pontuacao = resultadoApostadorFaseGrupos(usuariosLista[contadorUsuario],pontuacaoJogo,listaUsuarios[contadorUsuario][28+2*6*nomeGrupo+2*nomeJogo],usuariosLista[contadorUsuario][29+2*6*nomeGrupo+2*nomeJogo],int(usuarioMestre[28+2*6*nomeGrupo+2*nomeJogo]),int(usuarioMestre[29+2*6*nomeGrupo+2*nomeJogo]))

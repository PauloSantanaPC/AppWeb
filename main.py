...
def resultadoApostadorFaseGrupos(usuario,golMandanteApostador,golVisitanteApostador,golMandanteJogo,golVisitanteJogo):
                                    ...
                                    if nomeRodada == 1:
                                        ...
                                        if nomeJogo == 0:
                                            ...
                                            if usuarioMestre[28+2*6*nomeGrupo+2*nomeJogo] != '':
                                                ...
                                                st.subheader(int(usuario[28+2*6*nomeGrupo+2*nomeJogo]),int(usuario[29+2*6*nomeGrupo+2*nomeJogo]),int(usuarioMestre[28+2*6*nomeGrupo+2*nomeJogo]),int(usuarioMestre[29+2*6*nomeGrupo+2*nomeJogo]))
                                                usuario, pontuacao = resultadoApostadorFaseGrupos(usuario,0,1,0,1)
